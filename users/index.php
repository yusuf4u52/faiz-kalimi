...
if (!empty($values['Thali']) && (empty($values['ITS_No']) || empty($values['CONTACT']) || empty($values['WhatsApp']) || empty($values['niyazdate']) || empty($values['wingflat']) || empty($values['society']) || empty($values['Full_Address']))) {
