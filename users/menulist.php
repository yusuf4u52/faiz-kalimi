...
<body>
    ...
    <div class="container">
        ...
        <?php if (isset($_GET['action']) && $_GET['action'] == 'edit') { ?>
            <div class="alert alert-success" role="alert">Menu/Miqaat of <strong><?php echo date('d M Y', strtotime($_GET['date'])); ?></strong> is edited successfully.</div>
        <?php } ?>
                    ...
                    <form id="editmenu-<?php echo $values['id']; ?>" class="form-horizontal" method="post" action="savemenu.php">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="thaali <?php echo (!empty($values['menu_type']) && $values['menu_type'] != 'thaali' ? 'hidden' : ''); ?>">
                                ...
                                <div class="form-group row">
                                    <label for="extra" class="col-xs-4 control-label">Extra Item</label>
                                    <div class="col-xs-6">
                                        <input list="extra-item" type="text" class="form-control" name="menu_item[extra][item]" id="extra" value="<?php echo (!empty($menu_item['extra']['item']) ? $menu_item['extra']['item'] : ''); ?>">
                                    </div>
                                    <div class="col-xs-2">
                                        <input type="number" class="form-control" name="menu_item[extra][qty]" id="extraqty" min="1" value="<?php echo (!empty($menu_item['extra']['qty']) ? $menu_item['extra']['qty'] : '1'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="deletefood-<?php echo $values['id']; ?>" class="form-horizontal" method="post" action="savemenu.php">
                        ...
                        <input type="hidden" name="menu_date" value="<?php echo $values['menu_date']; ?>" />
                        <input type="hidden" name="menu_id" value="<?php echo $values['id']; ?>" />
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="thaali hidden">
                            ...
                            <div class="form-group row">
                                <label for="extra" class="col-xs-4 control-label">Extra Item</label>
                                <div class="col-xs-6">
                                    <input list="extra-item" type="text" class="form-control" name="menu_item[extra][item]" id="extra">
                                </div>
                                <div class="col-xs-2">
                                    <input type="number" class="form-control" name="menu_item[extra][qty]" id="extraqty" value="1" min="1">
                                </div>
                            </div>
                        </div>
                    </div>
