		...
		<div class="row">
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				foreach ($musaid_list as $musaid) {
					$result = mysqli_query($link, "SELECT id, Thali, Active, Name, ITS_No, contact, yearly_hub, Total_Pending, Previous_Due, Paid, thalicount, WhatsApp FROM thalilist where Total_Pending != 0 and thalisize != '' AND musaid='" . $musaid['email'] . "'");
