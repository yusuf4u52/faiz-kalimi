...
if ($menu_item_result->num_rows > 0) {
    $msgmenu .= '<table border="0" bgcolor="#FFFFFF" width="100%" cellpadding="3" cellspacing="3">
		<td align="center" valign="top">
			<table border="0" width="720" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="color:#333333; padding:1rem;">
				<tr>
					<td align="left">
						<img src="https://kalimijamaatpoona.org/testfmb/assets/img/logo.avif" alt="Faizul Mawaidil Burhaniya (Kalimi Mohalla)" width="90" height="90"> 
					</td>
    ...
    if (isset($_GET['menu_date'])) {
        header("Location: /testfmb/users/menu/edited.php?action=send&date=" . urlencode($_GET['menu_date']));
        exit;
    }
} else {
