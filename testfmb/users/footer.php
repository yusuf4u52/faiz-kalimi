                ...
                <script src="/testfmb/assets/js/arabic_numerals.js" defer></script>
                <script src="/testfmb/assets/js/date.js" defer></script>
                <script src="/testfmb/assets/js/hijri_date.js" defer></script>
                ...
                <script type="text/javascript" id="pwa-register-sw-js-extra">
                    ...
                    var pwa_sw = {
                        ...
                        "online_message_txt": "You're back online . <a href=\"javascript:location.reload()\">refresh<\/a>",
                        "manifest_name": "manifest.json"
                    };
                    /* ]]> */
                </script>
                <script type="text/javascript" src="/testfmb/assets/js/register-sw.js" defer></script>
                <script type="text/javascript" id="pwa_ptrfp_lib_script-js-extra">
                    var pwa_ptr_obj = {
                        "instrPullToRefresh": "Pull down to refresh",
                        "instrReleaseToRefresh": "Release to refresh",
                        "instrRefreshing": "Refreshing",
                        "instrptr_font_size": "0.85em",
                        "instrptr_font_color": "#212529"
                    };
                </script>
                <script type="text/javascript" src="/testfmb/assets/js/pulltorefresh-sw.js" defer></script>
                <script type="text/javascript" src="/testfmb/assets/js/main.js" defer></script>
                <script type="text/javascript" src="/testfmb/assets/js/menu.js" defer></script>
                </body>
