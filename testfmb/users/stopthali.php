...
if (in_array($action, ['stop_thali', 'stop_date_thali', 'admin_stop_thali'], true)) {
    ...
    if ($action === 'stop_thali') {
        header("Location: /testfmb/users/index.php?action=" . urlencode($resultAction) . "&sdate=" . urlencode($sdate) . "&edate=" . urlencode($edate));
        exit;
    }
    ...
    if ($action === 'stop_date_thali') {
        header("Location: /testfmb/users/stop_dates.php?action=" . urlencode($resultAction) . "&sdate=" . urlencode($sdate) . "&edate=" . urlencode($edate));
        exit;
    }
}
