...
if ($query->num_rows > 0) {
    ...
    if ($transporter->num_rows > 0) {
        header("Location: /testfmb/transporter/home.php");
        exit;
    } else {
        ...
        header("Location: /testfmb/index.php?status=" . urlencode($status));
        exit;
    }
}
            ...
            <div class="collapse navbar-collapse" id="headernavbar">
                <ul class="navbar-nav me-auto mx-xl-auto">
                    ...
                    <?php if (user_email_in(TRANSPORTER_MANAGEMENT_ACCESS_EMAILS)) { ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="/testfmb/users/transporter/hardstopthali.php">Hardstop Thali</a></li>
                    ...
                    <?php if (user_email_in(BACKEND_ACCESS_EMAILS)) { ?>
                        ...
                        <li class="nav-item"><a class="nav-link" target="_blank" rel="noopener noreferrer" href="/testfmb/sms/index.php">SMS</a></li>
                    <?php } ?>
                    <?php $transporterNav = db_query($link, "SELECT id FROM transporters WHERE Email = ?", "s", [$_SESSION['email']]);
                    if ($transporterNav->num_rows > 0) {
                        echo '<li class="nav-item"><a class="nav-link" href="/testfmb/transporter/home.php">Transporter Panel</a></li>';
                    } ?>
