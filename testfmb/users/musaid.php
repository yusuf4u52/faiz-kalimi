...
<div class="accordion" id="accordionMusaid">
	<?php foreach ($musaid_list as $musaid) {
        $result = db_query(
            $link,
            "SELECT * FROM thalilist WHERE Previous_Due > 4 AND Transporter IS NOT NULL AND musaid = ? AND hardstop != 1 ORDER BY `Paid %`",
            "s",
            [$musaid['email']]
        );
											...
											<form method="post">
												...
												<td>
													...
													<a data-bs-toggle="modal" href="#details-<?php echo e($values['Thali']); ?>">
														<img src="/testfmb/assets/img/view.avif" style="width:20px;height:20px;">
													</a>
												</td>
												...
												<td>
                                                    ...
                                                    $msg .= "*Pending Hoob:* ₹" . number_format((float) $values['Previous_Due']) . "\n\n";
												...
												<td><?php echo e((string) $values['Total_Pending']); ?></td>
