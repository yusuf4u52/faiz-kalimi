...
!(function (e, t) {
  ...
  var t,
    ...
    r = function () {
      ...
      function i(t) {
        ...
        (e.enable = !!i),
          i &&
            "pending" === e.state &&
            ((r = n.setupDOM(i)),
            i.shouldPullToRefresh() && (e.pullStartY = s(t)),
      ...
      function o(t) {
        r &&
          ...
          (e.pullStartY
            ? (e.pullMoveY = s(t))
            : r.shouldPullToRefresh() && (e.pullStartY = s(t)),
          "refreshing" !== e.state
            ? ("pending" === e.state &&
              ...
              e.distExtra > 0 &&
                ...
                "pulling" === e.state &&
                  e.distResisted > r.distThreshold &&
      ...
      return (
        e.pointerEventsEnabled && e.supportsPointerEvents
          ? (window.addEventListener("pointerup", l),
            ...
            window.addEventListener("pointermove", o, d))
          : (window.addEventListener("touchend", l),
            window.addEventListener("touchstart", i),
            window.addEventListener("touchmove", o, d)),
          ...
          destroy: function () {
            e.pointerEventsEnabled && e.supportsPointerEvents
              ? (window.removeEventListener("pointerdown", i),
                ...
                window.removeEventListener("pointermove", o, d))
              : (window.removeEventListener("touchstart", i),
                window.removeEventListener("touchend", l),
                window.removeEventListener("touchmove", o, d)),
    ...
    i = {
      ...
      instructionsPullToRefresh: superpwa_ptr_obj.instrPullToRefresh,
      instructionsReleaseToRefresh: superpwa_ptr_obj.instrReleaseToRefresh,
      instructionsRefreshing: superpwa_ptr_obj.instrRefreshing,
      refreshTimeout: 500,
      getMarkup: function () {
      ...
      getStyles: function () {
        return (
          ...
          superpwa_ptr_obj.instrptr_font_size +
          ";\n  font-weight: bold;\n  top: 0;\n  height: 0;\n  transition: height 0.3s, min-height 0.3s;\n  text-align: center;\n  width: 100%;\n  overflow: hidden;\n  display: flex;\n  align-items: flex-end;\n  align-content: stretch;\n}\n\n.__PREFIX__box {\n  padding: 10px;\n  flex-basis: 100%;\n}\n\n.__PREFIX__pull {\n  transition: none;\n}\n\n.__PREFIX__text {\n  margin-top: .33em;\n  color: " +
          superpwa_ptr_obj.instrptr_font_color +
          ";\n}\n\n.__PREFIX__icon {\n  color: " +
          superpwa_ptr_obj.instrptr_font_color +
