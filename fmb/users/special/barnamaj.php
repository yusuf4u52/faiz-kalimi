                    ...
                    <tbody>
                        <?php while ($values = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><?php echo $values['wingflat'] . ', ' . $values['society']; ?></td>
                                <td><?php echo ($max_days[0] > 0) ? round($values['thalicount'] * 100 / $max_days[0]) . '%' : '0%'; ?> of days</td>
