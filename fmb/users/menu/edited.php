    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <table class="table table-striped table-hover display">
                            ...
                            <tbody>
                                ...
                                if ($thali->num_rows > 0) {
                                    ...
                                    $thali = mysqli_query($link, "SELECT id, Thali, tiffinno, thalisize, Transporter from thalilist WHERE id IN (" . $userid . ") AND `hardstop` != 1 AND Active != 0 AND thalisize != 'Roti' ORDER BY Transporter");
                                    $sabji = 0;
                                    $tarkari = 0;
                                    $rice = 0;
                ...
                <?php
                    $totalthali = mysqli_query($link, "SELECT count(*) as tcount FROM `thalilist` WHERE `hardstop` != 1 AND Active != 0 AND thalisize != 'Roti'");
