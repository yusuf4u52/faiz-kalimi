...
if ($action === null) {
    header("Location: /fmb/users/roti/distribute.php");
    exit;
}
...
if ($makerId <= 0 || $distributionDate === '' || $flourDistributed === null || $oilDistributed === null
    ...
    header("Location: /fmb/users/roti/distribute.php?action=error");
    exit;
}
...
if ($action === 'add_rdistribute') {
    ...
    header("Location: /fmb/users/roti/distribute.php?action=" . ($wasUpdate ? 'edit' : 'add')
...
if ($action === 'edit_rdistribute') {
    ...
    header("Location: /fmb/users/roti/distribute.php?action=edit&maker=" . $makerId . "&distribution_date=" . urlencode($distributionDate));
    exit;
}
...
if ($action === 'delete_rdistribute') {
    ...
    header("Location: /fmb/users/roti/distribute.php?action=delete&maker=" . $makerId . "&distribution_date=" . urlencode($distributionDate));
    exit;
}
