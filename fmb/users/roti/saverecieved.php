...
if ($action === null) {
    header("Location: /fmb/users/roti/recieved.php");
    exit;
}
...
if ($makerId <= 0 || $recievedDate === '' || $rotiRecieved === null || $rotiRecieved < 0
    ...
    header("Location: /fmb/users/roti/recieved.php?action=error");
    exit;
}
...
if ($action === 'add_rrecieved') {
    ...
    header("Location: /fmb/users/roti/recieved.php?action=" . ($wasUpdate ? 'edit' : 'add')
...
if ($action === 'edit_rrecieved') {
    ...
    header("Location: /fmb/users/roti/recieved.php?action=edit&maker=" . $makerId . "&recieved_date=" . urlencode($recievedDate));
    exit;
}
...
if ($action === 'delete_rrecieved') {
    ...
    header("Location: /fmb/users/roti/recieved.php?action=delete&maker=" . $makerId . "&recieved_date=" . urlencode($recievedDate));
    exit;
}
