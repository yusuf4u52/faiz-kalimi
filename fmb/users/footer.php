    ...
    <script src="https://cdn.jsdelivr.net/npm/moment-hijri@3.0.0/moment-hijri.min.js" defer ></script>
    <script src="/fmb/users/assets/js/arabic_numerals.js" defer ></script>
    <script src="/fmb/users/assets/js/date.js" defer ></script>
    <script src="/fmb/users/assets/js/hijri_date.js" defer ></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@5.11.5/main.min.js" defer ></script>
    ...
    <script type="text/javascript" id="pwa-register-sw-js-extra">
        /* <![CDATA[ */
        var pwa_sw = {"url":"\/fmb\/sw.js","disable_addtohome":"0","enableOnDesktop":"","offline_message":"1","offline_message_txt":"You are currently offline.","online_message_txt":"You're back online . <a href=\"javascript:location.reload()\">refresh<\/a>","manifest_name":"manifest.json"};
        /* ]]> */
    </script>
	<script type="text/javascript" src="/fmb/users/assets/js/register-sw.js" defer ></script>
    <script type="text/javascript" id="pwa_ptrfp_lib_script-js-extra">
        var pwa_ptr_obj = {"instrPullToRefresh":"Pull down to refresh","instrReleaseToRefresh":"Release to refresh","instrRefreshing":"Refreshing","instrptr_font_size":"0.85em","instrptr_font_color":"#212529"};
    </script>
	<script type="text/javascript" src="/fmb/users/assets/js/pulltorefresh-sw.js" defer ></script>
    <script type="text/javascript" src="/fmb/users/assets/js/main.js" defer ></script>
    <script type="text/javascript" src="/fmb/users/assets/js/menu.js" defer ></script>
    </body>
</html>