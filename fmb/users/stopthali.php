...
if (isset($_POST['start_date']) && isset($_POST['end_date'])) {
    ...
    if (isset($_POST['action']) && ($_POST['action'] == 'admin_stop_thali' || $_POST['action'] == 'admin_start_thali')) {
        $GivenDate = new DateTime($_POST['start_date'] . '00:00:00');
        $CurrentDate = date('Y-m-d H:i:s');
    }

    if (isset($_POST['action']) && ($_POST['action'] == 'stop_thali' || $_POST['action'] == 'stop_date_thali' || $_POST['action'] == 'admin_stop_thali')) {
    ...
    if (isset($_POST['action']) && ($_POST['action'] == 'start_thali' || $_POST['action'] == 'admin_start_thali')) {
