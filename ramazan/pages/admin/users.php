...
if ($itsid > 0) {
    ...
    if (is_null($result)) {
        do_redirect_with_message('/admin/users', "ITS ID ($itsid) not found.");
    }
    $user_data = $result;
}
...
function show_user_list()
{
    ...
    <div class="card">
        <div class="card-header row">
            ...
            <div class="col-6"><a href="<?= $url ?>/admin/users/0" class="btn btn-gradient-success btn-rounded btn-fw">Add New</a></div>
            </di>
            <div class="card-body">
...
function __show_link2markaz_list($row, $index)
{
    ...
    return "<a href='$uri/admin/users/$itsid' class='btn btn-gradient-success btn-rounded btn-fw'>Edit</a>";
}
...
function _handle_add_user()
{
    ...
    do_redirect_with_message('/admin/users', $msg);
}