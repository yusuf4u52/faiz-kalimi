...
if ($year > 0) {
    ...
    if (is_null($result)) {
        do_redirect_with_message('/admin/users', "Year ($year) not found.");
    }
    $hijri_data = $result;
}
...
function show_year_list()
{
    ...
    <div class="card">
        <div class="card-header row">
            ...
            <div class="col-6"><a href="<?= $url ?>/admin/years/0" class="btn btn-gradient-success btn-rounded btn-fw">Add New</a></div>
            </di>
            <div class="card-body">
...
function __show_link2markaz_list($row, $index)
{
    ...
    return "<a href='$uri/admin/years/$year' class='btn btn-gradient-success btn-rounded btn-fw'>Edit</a>";
}
...
function _handle_add_year_data()
{
    ...
    do_redirect_with_message('/admin/years', $msg);
}