    ...
    if (file_exists($filePath)) {
        try {
            ...
            if (!DEFINED('NO_TEMPLATE')) {
                if( DEFINED('SPECIAL_TEMPLATE') ) {
                    require_once SPECIAL_TEMPLATE;
                } else {
...
{
    //current_directory: is the base directory.
...
/**
 * Function takes care of session initiation.
 * If session is not already started, than starts that.
 * 
 * @return bool
 */
