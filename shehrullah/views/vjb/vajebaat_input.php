...
function content_display() {
    ...
    <div class='card'>
        <div class="card-body controls">
            <h2 class="mb-2">Vajebaat Form Input</h2>
            <h6 class="mb-3">for sila fitra calculation</h6>
            ...
            <form id="contact-form" method="post" action="<?= $uri ?>/vjb.vjb_print" role="form">
                <!--  INPUT FORM START -->
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label" for="form_name">ITS ID *</label> <input readonly type="text" name="itsid" id="itsid"
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label" for="form_lastname">Full name *</label> <input id="name" type="text" name="name"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Mobile *</label> <input id="mobile" type="text" name="mobile"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Address *</label>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Gents Count *</label> <input id="form_mardo_count" type="number"
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Ladies Count *</label> <input id="form_bairo_count"
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Kids *</label> <input id="form_kids_count" type="number"
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Marhoom Count *</label> <input id="form_amwat_count" value="0"
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Hamal Count *</label> <input id="form_hamal_count" value="0"
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label" for="form_email">Token *</label> <input id="token" value="0" type="number"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" class="btn btn-light btn-send" value="Register">
                        </div>
                    </div>
                </div>
            </form>
