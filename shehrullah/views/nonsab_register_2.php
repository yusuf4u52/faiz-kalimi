        ...
        <div class="card-body">
            ...
            <form method="post">
                ...
                <input type="hidden" value="<?= $hof_id ?>" name="hof_id" id="hof_id">
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-3 form-label">HOF ID</label>
                        <div class="col-9">
                            <?php if($hof_id == 0) { ?>
                                <input type="text" readonly class="form-control" value="Please enter HOF details.">
                            <?php } else { ?>
                                <input type="text" readonly class="form-control" value="<?= $hof_id ?>">
                            <?php } ?>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="its_id" class="col-3 form-label">ITS ID</label>
                        <div class="col-9">
                            <?php 
                            $action = $_POST['action']??'';
                            if( $action === 'hof' ) {                    
                    ...
                    <div class="mb-3 row">
                        <label for="full_name" class="col-3 form-label">Full name</label>
                        <div class="col-9">
                    ...
                    <div class="mb-3 row">
                        <label for="gender" class="col-3 form-label">Gender (M or F)</label>
                        <div class="col-9">
                    ...
                    <div class="mb-3 row">
                        <label for="age" class="col-3 form-label">Age</label>
                        <div class="col-9">
                    ...
                    <div class="mb-3 row">
                        <label for="misaq" class="col-3 form-label">Misaq (Y or N)</label>
                        <div class="col-9">
                    ...
                    <div class="form-group" style="font-weight:20px;margin-top: 25px;">
                        ...
                        <a href='<?=$uri . '/nonsab_register/' . $enc_hof_id?>' class="btn btn-light">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
