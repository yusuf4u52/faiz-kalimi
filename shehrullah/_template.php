...
<head>
    ...
    <link rel="stylesheet" href="/shehrullah/assets/css/main.css" />
</head>
<body>
    <?php if ($header) { ?>
        <header class="header">
            <div class="container-fluid py-2">
                <div class="row align-items-center">
                    <div class="col-4">
                        <a href="<?= $homepage ?>"><img class="img-fluid" src="/shehrullah/assets/img/logo.png" alt="Anjuman-E-Kalimi - Poona" width="110" height="110" /></a>
                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="headernavbar">
                            <ul class="navbar-nav me-auto mx-xl-auto">
                                <li class="nav-item"><a class="nav-link" href="#"><?=$udata->name??''?></a></li>
