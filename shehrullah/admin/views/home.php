            ...
            <!-- <div class="col-md-4 col-sm-6 col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?= $url ?>/temp_sabeel" class="btn btn-primary">GO >></a>
                    </div>
                </div>
            </div> -->
        <?php }
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?= $url ?>/receipt_list" class="btn btn-primary">GO >></a>
                    </div>
                </div>
            </div>
        <?php }
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card bg-gradient-secondary">
                    <div class="card-body">
                        ...
                        <a href="<?= $url ?>/report/fmb_lq_niyat" class="btn btn-primary">GO >></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card bg-gradient-secondary">
                    <div class="card-body">
                        ...
                        <a href="<?= $url ?>/registrations" class="btn btn-primary">GO >></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12">
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?= $url ?>/vjb.slot" class="btn btn-primary">GO >></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?= $url ?>/report/vjb_pending" class="btn btn-primary">GO >></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-12">
