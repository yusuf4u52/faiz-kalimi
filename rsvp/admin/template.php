...
<head>
    ...
    <link rel="shortcut icon" href="<?= getAppData('BASE_URI') ?>/assets/img/logo.avif" />
    ...
    <link rel="stylesheet" href="<?= getAppData('BASE_URI') ?>/assets/css/main.css" />
</head>
<body>
    <header class="header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-4">
                    <a href="<?= getAppData('BASE_URI') ?>"><img class="img-fluid" src="<?= getAppData('BASE_URI') ?>/assets/img/logo.avif" alt="Miqaat RSVP (Kalimi Mohalla - Poona)" width="153" height="153" /></a>
                </div>
